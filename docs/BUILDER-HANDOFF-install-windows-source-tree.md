...
**CM-1 CLOSED — independent Standard focused-correction review returned PASS.**
Documentation only. **Nothing merged, nothing pushed.** No VM started, no
dependency installed, no provider session opened. Merge authority remains Blue's
alone; this document records evidence, it does not authorize a merge.

### Round 2 verdict — retained verbatim

```
VERDICT: PASS
CLASS: Standard focused correction review
INDEPENDENCE: CONFIRMED
RANGE: 8c53f29d4936c5bdf085d17e81ade15d07d53ab3...bdc48ee21837fee913269d02d4a7a7752d791ae6
CUMULATIVE SHA-256: 38a0733dad551bb075a07cb3c3b610a37945aa9d543da51917aed9b16a914113
FOCUSED SHA-256: 333202c5dbfe741f897cd5bd4916aafea3f0f231702bdbe17ecb1a3880a8476a
```

The reviewed content tip is `bdc48ee21837fee913269d02d4a7a7752d791ae6`. The
commit carrying this section is an **administrative handoff tail** above that
reviewed tip: it modifies only this handoff document and touches no reviewed
content.
...
and stays on the record. The round-2 PASS above is a *separate* verdict on a
*separate* range — it does not retroactively pass `8c53f29`, and nothing about
round 1 is reinterpreted as a pass.
...
| **Reviewed content tip** (round-2 PASS applies here) | `bdc48ee21837fee913269d02d4a7a7752d791ae6` |
| Handoff tail / branch tip | this document's administrative tail commit; exact SHA accompanies the merge request |
...
Two pinned artifacts, both produced with `git diff --output`, both regenerated as
an independent twin and byte-compared before the twin was removed. Both are
gitignored (`.agent-review*.diff`) and must never be committed.

**Cumulative** — the whole reviewed delta, `reviewedBase...reviewedTip`:

```
git diff --output=.agent-review-install-windows-source-tree.diff d64192ba680d932623e5557793a159076e26d8d6...bdc48ee21837fee913269d02d4a7a7752d791ae6
```

| Field | Value |
|---|---|
| Size | 74,445 bytes |
| SHA-256 | `38a0733dad551bb075a07cb3c3b610a37945aa9d543da51917aed9b16a914113` |
| Twin | byte-identical; twin removed |

**Focused** — the round-1 correction only, `revision 1 tip...revision 2 tip`:

```
git diff --output=.agent-review-install-windows-source-tree-correction.diff 8c53f29d4936c5bdf085d17e81ade15d07d53ab3...bdc48ee21837fee913269d02d4a7a7752d791ae6
```

| Field | Value |
|---|---|
| Size | 28,619 bytes |
| SHA-256 | `333202c5dbfe741f897cd5bd4916aafea3f0f231702bdbe17ecb1a3880a8476a` |
| Twin | byte-identical; twin removed |

Both identities match the values named in the round-2 verdict (§ 0). The
cumulative artifact was **not** regenerated when the focused one was produced;
it still carries the exact bytes the review consumed.
...
Reviewer verdict (round 2, range `8c53f29...bdc48ee`): `VERDICT: PASS` — retained
verbatim in § 0, with `CLASS: Standard focused correction review` and
`INDEPENDENCE: CONFIRMED`.

Reviewer verdict source (round 2): independent Standard focused-correction
review, bound to both pinned artifacts — cumulative SHA-256
`38a0733dad551bb075a07cb3c3b610a37945aa9d543da51917aed9b16a914113` and focused
SHA-256 `333202c5dbfe741f897cd5bd4916aafea3f0f231702bdbe17ecb1a3880a8476a` (§ 15).

**This PASS is a review verdict, not a merge authorization.** Per `AGENTS.md`
§ How I work item 2, Blue is the sole merge authority; `scripts/merge-gate.ps1`
checks evidence and never decides acceptance.
