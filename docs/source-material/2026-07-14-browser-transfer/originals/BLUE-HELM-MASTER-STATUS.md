...
> exit 1; refusal explicitly states whole-video is NOT a fallback; $0) · **D ⏳ partial** (fields
> hide on mode switch = by design; REMAINING: launch the transcript run and
> verify argv has NO `--start-offset` and no `BUG:` line; reopened video-mode
> fields empty) · **E ✅** (90+min video refused: measured=6873 limit=5400,
...
- **Day 1 (Fri):** restart → live tests A–E → #9 analysisMode fail-closed → 9c timestamps. (9b ✅ merged @ `4da1572`.)
